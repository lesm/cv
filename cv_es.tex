...
\cvlistdoubleitem{Español (Nativo)}{Inglés, \emph{\small{buen nivel conversacional (Nivel B1).}}}
...
\section{Experiencia laboral}
  ...
  \cventry{Setp. 2019 -- Dic. 2019}{Ruby on Rails Developer}{Warepow}{Santiago de Querétaro, Qro}{}{
    Agregando funcionalidad a un sistema en Ruby on Rails usando TDD. Sistema para al control administrativo y financiero de obras. Trabajando fines de semana.
  }
  ...
  \begin{itemize}
    ...
    \item \textbf{cfdi\_parser}
      \begin{itemize}
        \item Actualización para soportar los cambios del CFDI 3.3
      \end{itemize}
  \end{itemize}}
  \cventry{}{}{}{}{}{
    \begin{itemize}
