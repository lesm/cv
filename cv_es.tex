...
\cventry{2011--2018}{Ing. En Sistemas Computacionales}{Instituto Tecnológico de Oaxaca, México}{}{}{}  % Arguments not required can be left empty
...
\cvlistdoubleitem{Español (Nativo)}{Inglés, buen nivel.}
...
\section{Experiencia laboral}
  \cventry{Ag. 2019 -- Acte.}{Ruby on Rails Developer}{Zentiglo}{Santiago de Querétaro, Qro}{}{
    Agregando funcionalidad al sistema principal de Zentiglo usando TDD, sistema de Facturación Electrónica.
    \newline \newline
  ...
  \cventry{Sept. 2019 -- Dic. 2019}{Ruby on Rails Developer}{Warepow}{Santiago de Querétaro, Qro}{}{
  ...
  \cventry{May. 2016 -- Ag. 2018}{Ruby on Rails Developer}{LogicalBricks}{Oaxaca de Juárez, Oax}{}{
    ...
    Actividades importantes:
    \begin{itemize}
      \item Mantenimiento y actualización de gemas públicas y privadas de LogicalBricks, por ejemplo:
      \begin{itemize}
        \item \textbf{fm\_timbrado\_cfdi, fm\_layout y cfdi\_parser}
          ...
          \end{itemize}
      \end{itemize}
      \item Mantenimiento y actualización de los principales sistemas de LogicalBricks por ejemplo:
      \begin{itemize}
...
\subsection{Asistente}
  \cventry{2014 - 2018}{Pláticas}{por Ruby Oaxaca Comunidad (Oaxaca.rb)}{}{}{
    Action Cable,
...
\subsection{Organizador}
  \cventry{2015-2017}{Talleres}{Coderetreat 2015, 2016 y 2017}{Oaxaca de Juárez, Oax}{Global day of CodeRetreat}{}
...
\section{Herramientas y lenguajes de Desarrollo}
  \cvitem{Lenguajes}{Java, Ruby, SQL, JavaScript}
  \cvitem{Frameworks}{Rails(4,5), Vue(aprendiendo), Bootstrap}
  \cvitem{DBMS}{MySQL, PostgreSQL}
  \cvitem{Sistemas Linux}{Debian, Ubuntu, ArchLinux, Chakra}
  \cvitem{SCV}{Git(Github, Bitbucket, Gitlab)}
  \cvitem{Integración continua}{Semaphore CI, Bitbucket Pipelines}
  \cvitem{Workers}{Delayed\_job, Sidekiq}
  \cvitem{Otros}{Vim, Tmux, RVM, Docker, Zsh, Yakuake, Jira, Trello, Redmine}
...
\section{Herramientas de Desarrollo relacionadas con Rails}
  \cvitem{Pruebas}{Rspect, Minitest, Capybara, Shoulda-Matchers, FactoryGirl/FactoryBot, VCR, WebMock}
